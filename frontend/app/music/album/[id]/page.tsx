  ...
  if (!album) {
    return (
      <div className="flex flex-col items-center justify-center py-32 min-h-screen">
        ...
        <p className="text-yt-text-muted">{t('music_album_not_found')}</p>
      </div>
    )
  }
    ...
    <div className="px-4 py-6 max-w-4xl mx-auto min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row gap-6 mb-8">
        ...
        <div className="flex flex-col justify-end min-w-0">
          <p className="text-yt-text-muted text-xs uppercase tracking-widest mb-1">{t('music_album_label')}</p>
          ...
          <div className="flex items-center gap-2 text-yt-text-muted text-xs">
            ...
            {album.trackCount && <><span>•</span><span>{album.trackCount} {album.trackCount !== 1 ? t('music_tracks') : t('music_track')}</span></>}
      ...
      <div className="flex items-center gap-3 px-3 pb-2 mb-1 text-yt-text-muted text-xs uppercase tracking-wide border-b border-yt-border/40">
        ...
        <span className="flex-1">{t('music_track')}</span>
      ...
      {album.description && (
        <div className="mt-8">
          <h2 className="text-yt-text text-base font-semibold mb-2">{t('music_about')}</h2>
