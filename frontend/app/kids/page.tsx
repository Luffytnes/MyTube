...
const CATEGORIES: { key: string; labelKey: keyof Translations }[] = [
  ...
  { key: 'cartoons', labelKey: 'kids_cat_cartoons' },
  { key: 'education', labelKey: 'kids_cat_education' },
  { key: 'music', labelKey: 'cat_music' },
  { key: 'stories', labelKey: 'kids_cat_stories' },
  { key: 'science', labelKey: 'cat_science' },
]
...
export default function KidsPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Colourful header for kids */}
      <div className="sticky top-14 z-30 bg-yt-bg border-b border-yt-border/40 px-4 py-3 flex items-center gap-4">
        <h1 className="text-yt-text font-bold text-lg flex-shrink-0 flex items-center gap-2">
      ...
      <div className="px-4 py-6">
        {error ? (
          ...
          <VideoGrid videos={videos} loading={loading} emptyMessage={t('kids_empty')} />
        )}
      </div>
    </div>
  )
