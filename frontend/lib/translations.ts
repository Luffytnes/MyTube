...
export interface Translations {
  ...
  comments_title: string; comments_sort_top: string; comments_sort_new: string
  comments_error: string; comments_empty: string; comments_more: string
  hashtag_empty: string
  ...
  settings_vpn_all_failed: string; settings_vpn_reset_failover: string; settings_vpn_rotated: string
  ...
  nav_news: string
  nav_iptv: string
  iptv_title: string; iptv_live: string; iptv_all_channels: string
  iptv_not_configured: string; iptv_not_configured_desc: string
  iptv_loading: string; iptv_error: string; iptv_search: string
  iptv_settings: string; iptv_server: string; iptv_username: string
  ...
  iptv_season: string; iptv_episode_short: string; iptv_format_unsupported: string
  ...
  // TV
  tv_home: string; tv_search_placeholder: string; tv_favorites: string; tv_back: string; tv_no_favorites: string
  // Kids / Live / Shorts
  nav_kids: string; nav_live: string; nav_shorts: string
  kids_empty: string; kids_cat_cartoons: string; kids_cat_education: string; kids_cat_stories: string
  live_empty: string; shorts_empty: string
  tab_shorts: string; tab_live: string
}

export const translations: Record<Lang, Translations> = {
  en: {
    nav_home: 'Home', nav_trending: 'Trending', nav_history: 'History', nav_back: 'Back',
    nav_watchLater: 'Watch Later', nav_music: 'MyTube Music',
    ...
    comments_title: 'Comments', comments_sort_top: 'Top comments', comments_sort_new: 'Newest first',
    comments_error: 'Failed to load comments.', comments_empty: 'No comments yet.',
    comments_more: 'Open on YouTube to see all comments.',
    hashtag_empty: 'No videos found for this hashtag.',
    ...
    settings_vpn_all_failed: 'No config could reach YouTube. Wireproxy has been disabled.', settings_vpn_reset_failover: 'Retry all configs', settings_vpn_rotated: 'VPN rotated →',
    ...
    nav_news: 'News',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'Live', iptv_all_channels: 'All channels',
    iptv_not_configured: 'IPTV not configured', iptv_not_configured_desc: 'Add your Xtream credentials in Settings to access live TV.',
    iptv_loading: 'Loading channels…', iptv_error: 'Failed to load channels.',
    iptv_search: 'Search channels…', iptv_settings: 'MyTube TV Settings',
    ...
    iptv_season: 'Season', iptv_episode_short: 'Ep.', iptv_format_unsupported: 'Format not supported by your browser (H.265/HEVC or AVI).',
    ...
    tv_home: 'Home', tv_search_placeholder: 'Search channels, movies, series…', tv_favorites: 'Favorites', tv_back: 'Back to MyTube', tv_no_favorites: 'No favorites yet',
    nav_kids: 'Kids', nav_live: 'Live', nav_shorts: 'Shorts',
    kids_empty: 'No kids content found', kids_cat_cartoons: 'Cartoons', kids_cat_education: 'Educational', kids_cat_stories: 'Stories',
    live_empty: 'No live streams found', shorts_empty: 'No shorts found',
    tab_shorts: 'Shorts', tab_live: 'Live',
  },
  fr: {
    nav_home: 'Accueil', nav_trending: 'Tendances', nav_history: 'Historique', nav_back: 'Retour',
    nav_watchLater: 'À regarder plus tard', nav_music: 'MyTube Music',
    ...
    comments_title: 'Commentaires', comments_sort_top: 'Meilleurs commentaires', comments_sort_new: 'Plus récents',
    comments_error: 'Impossible de charger les commentaires.', comments_empty: 'Aucun commentaire pour l\'instant.',
    comments_more: 'Ouvrir sur YouTube pour voir tous les commentaires.',
    hashtag_empty: 'Aucune vidéo trouvée pour ce hashtag.',
    ...
    settings_vpn_all_failed: 'Aucun .conf ne permet d\'accéder à YouTube. Wireproxy a été désactivé.', settings_vpn_reset_failover: 'Réessayer tous les .conf', settings_vpn_rotated: 'VPN basculé →',
    ...
    iptv_loading: 'Chargement des chaînes…', iptv_error: 'Impossible de charger les chaînes.',
    iptv_search: 'Rechercher une chaîne…', iptv_settings: 'Paramètres MyTube TV',
    ...
    iptv_season: 'Saison', iptv_episode_short: 'Ép.', iptv_format_unsupported: 'Format non supporté par votre navigateur (H.265/HEVC ou AVI).',
    ...
    tv_home: 'Accueil', tv_search_placeholder: 'Rechercher chaînes, films, séries…', tv_favorites: 'Favoris', tv_back: 'Retour à MyTube', tv_no_favorites: 'Aucun favori pour l\'instant',
    nav_kids: 'Kids', nav_live: 'Direct', nav_shorts: 'Shorts',
    kids_empty: 'Aucun contenu enfants trouvé', kids_cat_cartoons: 'Dessins animés', kids_cat_education: 'Éducatif', kids_cat_stories: 'Histoires',
    live_empty: 'Aucun live trouvé', shorts_empty: 'Aucun short trouvé',
    tab_shorts: 'Shorts', tab_live: 'Direct',
  },
  es: {
    nav_home: 'Inicio', nav_trending: 'Tendencias', nav_history: 'Historial', nav_back: 'Volver',
    nav_watchLater: 'Ver más tarde', nav_music: 'MyTube Music',
    ...
    comments_title: 'Comentarios', comments_sort_top: 'Mejores comentarios', comments_sort_new: 'Más recientes',
    comments_error: 'Error al cargar comentarios.', comments_empty: 'Sin comentarios todavía.',
    comments_more: 'Abrir en YouTube para ver todos los comentarios.',
    hashtag_empty: 'No se encontraron vídeos para este hashtag.',
    ...
    settings_vpn_all_failed: 'Ningún .conf puede acceder a YouTube. Wireproxy ha sido desactivado.', settings_vpn_reset_failover: 'Reintentar todos los .conf', settings_vpn_rotated: 'VPN rotado →',
    ...
    nav_news: 'Noticias',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'En vivo', iptv_all_channels: 'Todos los canales',
    iptv_not_configured: 'IPTV no configurado', iptv_not_configured_desc: 'Añade tus credenciales Xtream en Ajustes para acceder a la TV en directo.',
    iptv_loading: 'Cargando canales…', iptv_error: 'Error al cargar los canales.',
    iptv_search: 'Buscar canales…', iptv_settings: 'Ajustes MyTube TV',
    ...
    iptv_season: 'Temporada', iptv_episode_short: 'Ep.', iptv_format_unsupported: 'Formato no compatible con su navegador (H.265/HEVC o AVI).',
    ...
    tv_home: 'Inicio', tv_search_placeholder: 'Buscar canales, películas, series…', tv_favorites: 'Favoritos', tv_back: 'Volver a MyTube', tv_no_favorites: 'Sin favoritos aún',
    nav_kids: 'Kids', nav_live: 'En vivo', nav_shorts: 'Shorts',
    kids_empty: 'No se encontró contenido infantil', kids_cat_cartoons: 'Dibujos animados', kids_cat_education: 'Educativo', kids_cat_stories: 'Cuentos',
    live_empty: 'No se encontraron transmisiones en vivo', shorts_empty: 'No se encontraron shorts',
    tab_shorts: 'Shorts', tab_live: 'En vivo',
  },
  de: {
    nav_home: 'Startseite', nav_trending: 'Trends', nav_history: 'Verlauf', nav_back: 'Zurück',
    nav_watchLater: 'Später ansehen', nav_music: 'MyTube Music',
    ...
    comments_title: 'Kommentare', comments_sort_top: 'Top-Kommentare', comments_sort_new: 'Neueste zuerst',
    comments_error: 'Kommentare konnten nicht geladen werden.', comments_empty: 'Noch keine Kommentare.',
    comments_more: 'Auf YouTube öffnen, um alle Kommentare zu sehen.',
    hashtag_empty: 'Keine Videos für diesen Hashtag gefunden.',
    ...
    settings_vpn_all_failed: 'Keine Konfiguration konnte YouTube erreichen. Wireproxy wurde deaktiviert.', settings_vpn_reset_failover: 'Alle Konfigurationen erneut versuchen', settings_vpn_rotated: 'VPN gewechselt →',
    settings_tab_playback: 'Video',
    ...
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'Live', iptv_all_channels: 'Alle Sender',
    iptv_not_configured: 'IPTV nicht konfiguriert', iptv_not_configured_desc: 'Füge deine Xtream-Zugangsdaten in den Einstellungen hinzu, um Live-TV zu nutzen.',
    iptv_loading: 'Sender werden geladen…', iptv_error: 'Sender konnten nicht geladen werden.',
    iptv_search: 'Sender suchen…', iptv_settings: 'MyTube TV-Einstellungen',
    ...
    iptv_season: 'Staffel', iptv_episode_short: 'Ep.', iptv_format_unsupported: 'Format nicht unterstützt (H.265/HEVC oder AVI).',
    ...
    tv_home: 'Startseite', tv_search_placeholder: 'Sender, Filme, Serien suchen…', tv_favorites: 'Favoriten', tv_back: 'Zurück zu MyTube', tv_no_favorites: 'Noch keine Favoriten',
    nav_kids: 'Kids', nav_live: 'Live', nav_shorts: 'Shorts',
    kids_empty: 'Kein Kinderinhalt gefunden', kids_cat_cartoons: 'Zeichentrick', kids_cat_education: 'Lehrreich', kids_cat_stories: 'Geschichten',
    live_empty: 'Keine Livestreams gefunden', shorts_empty: 'Keine Shorts gefunden',
    tab_shorts: 'Shorts', tab_live: 'Live',
  },
  pt: {
    nav_home: 'Início', nav_trending: 'Em Alta', nav_history: 'Histórico', nav_back: 'Voltar',
    nav_watchLater: 'Assistir mais tarde', nav_music: 'MyTube Music',
    ...
    comments_title: 'Comentários', comments_sort_top: 'Melhores comentários', comments_sort_new: 'Mais recentes',
    comments_error: 'Falha ao carregar comentários.', comments_empty: 'Nenhum comentário ainda.',
    comments_more: 'Abrir no YouTube para ver todos os comentários.',
    hashtag_empty: 'Nenhum vídeo encontrado para esta hashtag.',
    ...
    settings_vpn_all_failed: 'Nenhum .conf conseguiu acessar o YouTube. Wireproxy foi desativado.', settings_vpn_reset_failover: 'Tentar todos os .conf novamente', settings_vpn_rotated: 'VPN alternado →',
    settings_tab_playback: 'Vídeo',
    ...
    nav_news: 'Notícias',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'Ao vivo', iptv_all_channels: 'Todos os canais',
    iptv_not_configured: 'IPTV não configurado', iptv_not_configured_desc: 'Adicione suas credenciais Xtream nas Configurações para acessar a TV ao vivo.',
    iptv_loading: 'Carregando canais…', iptv_error: 'Erro ao carregar canais.',
    iptv_search: 'Pesquisar canais…', iptv_settings: 'Configurações MyTube TV',
    ...
    iptv_season: 'Temporada', iptv_episode_short: 'Ep.', iptv_format_unsupported: 'Formato não suportado pelo seu navegador (H.265/HEVC ou AVI).',
    ...
    tv_home: 'Início', tv_search_placeholder: 'Pesquisar canais, filmes, séries…', tv_favorites: 'Favoritos', tv_back: 'Voltar ao MyTube', tv_no_favorites: 'Sem favoritos ainda',
    nav_kids: 'Kids', nav_live: 'Ao vivo', nav_shorts: 'Shorts',
    kids_empty: 'Nenhum conteúdo infantil encontrado', kids_cat_cartoons: 'Desenhos animados', kids_cat_education: 'Educacional', kids_cat_stories: 'Histórias',
    live_empty: 'Nenhuma transmissão ao vivo encontrada', shorts_empty: 'Nenhum short encontrado',
    tab_shorts: 'Shorts', tab_live: 'Ao vivo',
  },
  it: {
    nav_home: 'Home', nav_trending: 'Di tendenza', nav_history: 'Cronologia', nav_back: 'Indietro',
    nav_watchLater: 'Da guardare', nav_music: 'MyTube Music',
    ...
    comments_title: 'Commenti', comments_sort_top: 'Commenti migliori', comments_sort_new: 'Più recenti',
    comments_error: 'Impossibile caricare i commenti.', comments_empty: 'Nessun commento ancora.',
    comments_more: 'Apri su YouTube per vedere tutti i commenti.',
    hashtag_empty: 'Nessun video trovato per questo hashtag.',
    ...
    settings_vpn_all_failed: 'Nessun .conf riesce ad accedere a YouTube. Wireproxy è stato disabilitato.', settings_vpn_reset_failover: 'Riprovare tutte le config', settings_vpn_rotated: 'VPN cambiato →',
    settings_tab_playback: 'Video',
    ...
    nav_news: 'Notizie',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'In diretta', iptv_all_channels: 'Tutti i canali',
    iptv_not_configured: 'IPTV non configurato', iptv_not_configured_desc: 'Aggiungi le credenziali Xtream nelle Impostazioni per accedere alla TV in diretta.',
    iptv_loading: 'Caricamento canali…', iptv_error: 'Impossibile caricare i canali.',
    iptv_search: 'Cerca canali…', iptv_settings: 'Impostazioni MyTube TV',
    ...
    iptv_season: 'Stagione', iptv_episode_short: 'Ep.', iptv_format_unsupported: 'Formato non supportato dal browser (H.265/HEVC o AVI).',
    ...
    tv_home: 'Home', tv_search_placeholder: 'Cerca canali, film, serie…', tv_favorites: 'Preferiti', tv_back: 'Torna a MyTube', tv_no_favorites: 'Nessun preferito ancora',
    nav_kids: 'Kids', nav_live: 'In diretta', nav_shorts: 'Shorts',
    kids_empty: 'Nessun contenuto per bambini trovato', kids_cat_cartoons: 'Cartoni animati', kids_cat_education: 'Educativo', kids_cat_stories: 'Storie',
    live_empty: 'Nessuna diretta trovata', shorts_empty: 'Nessun short trovato',
    tab_shorts: 'Shorts', tab_live: 'In diretta',
  },
  ja: {
    nav_home: 'ホーム', nav_trending: 'トレンド', nav_history: '履歴', nav_back: '戻る',
    nav_watchLater: '後で見る', nav_music: 'MyTube Music',
    ...
    comments_title: 'コメント', comments_sort_top: '上位のコメント', comments_sort_new: '新しい順',
    comments_error: 'コメントを読み込めませんでした。', comments_empty: 'まだコメントはありません。',
    comments_more: 'すべてのコメントを見るにはYouTubeで開いてください。',
    hashtag_empty: 'このハッシュタグの動画が見つかりませんでした。',
    ...
    settings_vpn_all_failed: 'どの.confもYouTubeにアクセスできませんでした。Wireproxyが無効化されました。', settings_vpn_reset_failover: 'すべての.confを再試行', settings_vpn_rotated: 'VPN切替 →',
    ...
    nav_news: 'ニュース',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'ライブ', iptv_all_channels: 'すべてのチャンネル',
    iptv_not_configured: 'IPTVが設定されていません', iptv_not_configured_desc: 'ライブTVにアクセスするには、設定でXtreamの認証情報を追加してください。',
    iptv_loading: 'チャンネルを読み込み中…', iptv_error: 'チャンネルを読み込めませんでした。',
    iptv_search: 'チャンネルを検索…', iptv_settings: 'MyTube TV設定',
    ...
    iptv_season: 'シーズン', iptv_episode_short: '話', iptv_format_unsupported: 'ブラウザがこのフォーマットに対応していません (H.265/HEVC または AVI)。',
    ...
    tv_home: 'ホーム', tv_search_placeholder: 'チャンネル・映画・シリーズを検索…', tv_favorites: 'お気に入り', tv_back: 'MyTubeに戻る', tv_no_favorites: 'まだお気に入りはありません',
    nav_kids: 'Kids', nav_live: 'ライブ', nav_shorts: 'ショート',
    kids_empty: '子ども向けコンテンツが見つかりません', kids_cat_cartoons: 'アニメ', kids_cat_education: '教育', kids_cat_stories: 'お話',
    live_empty: 'ライブ配信が見つかりません', shorts_empty: 'ショートが見つかりません',
    tab_shorts: 'ショート', tab_live: 'ライブ',
  },
  ko: {
    nav_home: '홈', nav_trending: '인기', nav_history: '시청 기록', nav_back: '뒤로',
    nav_watchLater: '나중에 볼 동영상', nav_music: 'MyTube Music',
    ...
    comments_title: '댓글', comments_sort_top: '인기 댓글', comments_sort_new: '최신순',
    comments_error: '댓글을 불러올 수 없습니다.', comments_empty: '아직 댓글이 없습니다.',
    comments_more: '모든 댓글을 보려면 YouTube에서 여세요.',
    hashtag_empty: '이 해시태그에 대한 동영상을 찾을 수 없습니다.',
    ...
    settings_vpn_all_failed: '어떤 .conf도 YouTube에 접근할 수 없습니다. Wireproxy가 비활성화되었습니다.', settings_vpn_reset_failover: '모든 .conf 다시 시도', settings_vpn_rotated: 'VPN 전환 →',
    ...
    nav_news: '뉴스',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: '라이브', iptv_all_channels: '모든 채널',
    iptv_not_configured: 'IPTV가 구성되지 않았습니다', iptv_not_configured_desc: '라이브 TV에 액세스하려면 설정에서 Xtream 자격 증명을 추가하세요.',
    iptv_loading: '채널 로딩 중…', iptv_error: '채널을 불러올 수 없습니다.',
    iptv_search: '채널 검색…', iptv_settings: 'MyTube TV 설정',
    ...
    iptv_season: '시즌', iptv_episode_short: '화', iptv_format_unsupported: '브라우저에서 지원하지 않는 형식입니다 (H.265/HEVC 또는 AVI).',
    ...
    tv_home: '홈', tv_search_placeholder: '채널, 영화, 시리즈 검색…', tv_favorites: '즐겨찾기', tv_back: 'MyTube로 돌아가기', tv_no_favorites: '아직 즐겨찾기가 없습니다',
    nav_kids: 'Kids', nav_live: '라이브', nav_shorts: '쇼츠',
    kids_empty: '어린이 콘텐츠를 찾을 수 없습니다', kids_cat_cartoons: '만화', kids_cat_education: '교육', kids_cat_stories: '이야기',
    live_empty: '라이브 스트림을 찾을 수 없습니다', shorts_empty: '쇼츠를 찾을 수 없습니다',
    tab_shorts: '쇼츠', tab_live: '라이브',
  },
  ru: {
    nav_home: 'Главная', nav_trending: 'В тренде', nav_history: 'История', nav_back: 'Назад',
    nav_watchLater: 'Смотреть позже', nav_music: 'MyTube Music',
    ...
    comments_title: 'Комментарии', comments_sort_top: 'Лучшие комментарии', comments_sort_new: 'Сначала новые',
    comments_error: 'Не удалось загрузить комментарии.', comments_empty: 'Комментариев пока нет.',
    comments_more: 'Откройте на YouTube, чтобы увидеть все комментарии.',
    hashtag_empty: 'Видео по этому хэштегу не найдены.',
    ...
    settings_vpn_all_failed: 'Ни один .conf не смог подключиться к YouTube. Wireproxy отключён.', settings_vpn_reset_failover: 'Повторить все .conf', settings_vpn_rotated: 'VPN переключён →',
    ...
    nav_news: 'Новости',
    nav_iptv: 'MyTube TV',
    iptv_title: 'IPTV', iptv_live: 'Прямой эфир', iptv_all_channels: 'Все каналы',
    iptv_not_configured: 'IPTV не настроен', iptv_not_configured_desc: 'Добавьте учётные данные Xtream в Настройки для доступа к прямому ТВ.',
    iptv_loading: 'Загрузка каналов…', iptv_error: 'Не удалось загрузить каналы.',
    iptv_search: 'Поиск каналов…', iptv_settings: 'Настройки MyTube TV',
    ...
    iptv_season: 'Сезон', iptv_episode_short: 'Эп.', iptv_format_unsupported: 'Формат не поддерживается браузером (H.265/HEVC или AVI).',
    ...
    tv_home: 'Главная', tv_search_placeholder: 'Поиск каналов, фильмов, сериалов…', tv_favorites: 'Избранное', tv_back: 'Вернуться в MyTube', tv_no_favorites: 'Пока нет избранного',
    nav_kids: 'Kids', nav_live: 'Прямой эфир', nav_shorts: 'Shorts',
    kids_empty: 'Детский контент не найден', kids_cat_cartoons: 'Мультфильмы', kids_cat_education: 'Образовательное', kids_cat_stories: 'Сказки',
    live_empty: 'Трансляций не найдено', shorts_empty: 'Shorts не найдены',
    tab_shorts: 'Shorts', tab_live: 'Прямой эфир',
  },
}
