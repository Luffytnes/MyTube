...
export default function MusicSidebar() {
  ...
  return (
    <>
      ...
      <aside className="fixed left-3 top-16 bottom-20 z-40 hidden md:flex flex-col w-[72px] xl:w-52 liquid-glass rounded-2xl pt-3 pb-4 overflow-y-auto overflow-x-hidden transition-all">
